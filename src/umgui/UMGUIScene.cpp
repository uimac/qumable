...
public:
	...
	{
		current_x_ = x / double(umdraw_scene()->width());
		current_y_ = y / double(umdraw_scene()->height());
	...
	{
		//camera_->init(true, width, height);
	}
...
void UMGUIScene::resize(int width, int height)
{
