...
UMGUIBoard::UMGUIBoard()
	...
	, select_event_(std::make_shared<umbase::UMEvent>(eGUIEventObjectSelected))
{}
...
void UMGUIBoard::on_left_button_down(double x, double y)
{
	...
	umbase::UMEvent::Parameter param(this);
	select_event_->set_parameter(param);
	select_event_->notify();
